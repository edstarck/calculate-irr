<script>
  export let banks = [];
  import { prettify } from "../helpers/utils";
  ...
  <div class="b-card">
    ...
    <div class="b-card__body">
      ...
      <div class="b-card__block">
        ...
        <div class="b-card__value">
          {term}
          {declOfNum(term, ["год", "года", "лет"])}
        </div>
      </div>
      <div class="b-card__block">
